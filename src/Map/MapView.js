...
const MapView = () => {
  ...
  const { isLoaded } = useJsApiLoader({
    ...
    googleMapsApiKey: "AIzaSyBa_avZS8BLtjjVkoQihxUeBSFeoJWfrPQ",
  })
          ...
          <div align="center">
            ...
            <TableContainer component={Paper}>
              <Table size="small" aria-label="a dense table">
                <TableRow>
                  <TableCell align="center">
                    <strong>ผู้ป่วยวันนี้</strong>
                  </TableCell>
                  <TableCell align="center">{`${select.info.new_case
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")} คน`}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell
                    align="center"
                  ...
                  >
                    <strong>เสียชีวิตวันนี้</strong>
                  </TableCell>
                  <TableCell
                    align="center"
                    style={{ backgroundColor: "#fce4ec" }}
                  >{`${select.info.new_death
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")} คน`}</TableCell>
                </TableRow>
              </Table>
              ...
              <Table size="small" aria-label="a dense table">
                <TableRow>
                  <TableCell align="center">
                    <strong>ผู้ป่วยรวม</strong>
                  </TableCell>
                  <TableCell align="center">{`${select.info.total_case
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")} คน`}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell align="center" style={{ backgroundColor: "pink" }}>
                    <strong>เสียชีวิตรวม</strong>
                  </TableCell>
                  <TableCell
                    align="center"
                    style={{ backgroundColor: "pink" }}
                  >{`${select.info.total_death
                    .toString()
                    .replace(/\B(?=(\d{3})+(?!\d))/g, ",")} คน`}</TableCell>
                </TableRow>
              </Table>
